    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color_dd_expression" v="CASE &#xd;&#xa;WHEN elevation = 1 THEN '164,175,106' &#xd;&#xa;WHEN elevation = 2 THEN '132,142,81' &#xd;&#xa;WHEN elevation = 3 THEN '109,117,64' &#xd;&#xa;WHEN elevation = 4 THEN '86,94,46' &#xd;&#xa;WHEN elevation = 5 THEN '67,74,31' &#xd;&#xa;WHEN elevation = 6 THEN '85,75,49' &#xd;&#xa;WHEN elevation = 7 THEN '109,100,68' &#xd;&#xa;WHEN elevation = 8 THEN '137,125,90' &#xd;&#xa;WHEN elevation = 9 THEN '168,154,114' &#xd;&#xa;WHEN elevation = 10 THEN '203,189,144' &#xd;&#xa;ELSE '164,175,106'  &#xd;&#xa;END"/>
